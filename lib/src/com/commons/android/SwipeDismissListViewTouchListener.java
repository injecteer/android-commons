...
public class SwipeDismissListViewTouchListener implements View.OnTouchListener {
  ...
  private int targetId, backgroundId;
   ...
   */
  public SwipeDismissListViewTouchListener( ListView listView, int targetId, int backgroundId, DismissCallbacks callbacks ) {
  ...
  public boolean onTouch( View view, MotionEvent motionEvent ) {
    ...
    switch( motionEvent.getActionMasked() ){
        ...
        for( int i = 0; i < childCount; i++ ){
          ...
          if( rect.contains( x, y ) ){
            if( 0 == targetId )
              ...
              mDownView = child.findViewById( targetId );
              backgroundView = (TextView)child.findViewById( backgroundId );
            }
            break;
          }
        }
      ...
      case MotionEvent.ACTION_UP:{
        ...
        if( dismiss && mDownPosition != ListView.INVALID_POSITION ){
          ...
          mDownView.animate()
              ...
              .alpha( 0.7f ).setDuration( mAnimationTime )
      ...
      case MotionEvent.ACTION_MOVE:{
        ...
        if( mSwiping ){
          float offset = deltaX - mSwipingSlop;
          if( null != backgroundView ) backgroundView.setGravity( Gravity.CENTER_VERTICAL | ( 0 < offset ? Gravity.START : Gravity.END ) );
          mDownView.setTranslationX( offset );
          mDownView.setAlpha( Math.max( 0.7f, Math.min( 1f, 1f - 2f * Math.abs( deltaX ) / mViewWidth ) ) );
          return true;
        }
        break;
      }
  ...
  private void performDismiss( final View dismissView, final int dismissPosition ) {
    ...
    // callback when
    // all dismissed list item animations have completed. This triggers layout
    // on each animation
    ...
    animator.addListener( new AnimatorListenerAdapter() {
      ...
      public void onAnimationEnd( Animator animation ) {
        ...
        if( mDismissAnimationRefCount == 0 ){
          ...
          // Reset mDownPosition to avoid MotionEvent.ACTION_UP trying to start
          // a dismiss
    ...
    mPendingDismisses
        .add( new PendingDismissData( dismissPosition, dismissView ) );
    animator.start();
  }
}