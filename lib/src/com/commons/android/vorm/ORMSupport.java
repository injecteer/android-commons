...
public class ORMSupport {
  ...
  public static <T extends DomainClass> T querySingle( Class<T> clazz, String q, String... args ){
    Cursor c = db.rawQuery( q, args );
    try{
      return c.moveToNext() ? fromSql( clazz, c ) : null;
    }finally{ c.close(); }
  }
  ...
  public static <T extends DomainClass> Cursor cursorIn( Class<T> clazz, String name, Collection<?> ids ){
  ...
  public static <T extends DomainClass> List<T> findAllIn( Class<T> clazz, String name, Collection<?> ids ){
  ...
  public static <T extends DomainClass> Set<String> getIds( Class<T> clazz, String where, String... args ) {
    Set<String> ids = new HashSet<>();
    Cursor c = ORMSupport.db().rawQuery( "select _id from " + DomainClass.table( clazz ) + " where " + where, args );
    try{
